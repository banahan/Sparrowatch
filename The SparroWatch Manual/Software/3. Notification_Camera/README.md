...
__File Name__: 3. Notification_Camera/SparroWatch.py

The software in this folder corresponds to the simple, notification version of the Image Management Engine
