...
#########			DOCUMENTATION   		########
####################################################
# Input Value:		pin_to_check:	The pin that the fucntion will poll 
# Returned Value:	pin_state: 		The boolean value of the queried pin
####################################################
######## 		  IMPLEMENTATION 	 		########
####################################################
# if Shutdown_User_Button(pin_to_check):
